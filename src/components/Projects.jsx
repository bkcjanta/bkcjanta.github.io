    ...
    return (
        <Box bg={useColorModeValue('blue.100', 'black.800')} textAlign={"center"} id="projects" py={["1rem","3rem","4rem"]}   >
            ...
            <Box m={"auto"} w="85%"  p={"2rem"}    >
                <SimpleGrid direction={"row"} columns={[1,2,3]} spacing={5} textAlign={"left"} >
                    <Stack spacing={4}  _hover={{bg:"blue.900"}} bg={"black"} p={"15px"} borderRadius={"15px"} border={"1px"} >
                        <Text alignSelf={"center"} fontWeight={"bold"}>Asos clone</Text>
                        <Image cursor={"pointer"}  src={asos} />
                    ...
                    <Stack spacing={4} p={"15px"} _hover={{bg:"blue.900"}} bg={"black"} borderRadius={"15px"} border={"1px"}>
                        <Text  alignSelf={"center"} fontWeight={"bold"}>Jiomart clone </Text>
                        <Image cursor={"pointer"} src={jiomart} />
                    ...
                    <Stack spacing={4} _hover={{bg:"blue.900"}} bg={"black"} p={"15px"} borderRadius={"15px"} border={"1px"}>
                        ...
                        <Image  cursor={"pointer"}  src={amazon} />
